...
import TelegramBot from 'node-telegram-bot-api'; // 1. ይህ ተጨምሯል
...
// Gallery Routes (Get, Upload, Delete) - አልተለወጡም...
...
app.post('/api/pay', async (req, res) => {
  ...
  try {
    ...
    if (chapaRes.data.status === 'success') {
      ...
      // 2. የቴሌግራም ማሳወቂያ መላክ
      const msg = `🛍️ <b>አዲስ ትዕዛዝ ገብቷል!</b>\n\n👤 ስም: ${customerName}\n👗 አይነት: ${productName}\n💰 ብር: ${amount} ETB`;
      await sendTelegramTab(msg);
